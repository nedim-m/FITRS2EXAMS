...
namespace exam.Services.Services
{
    ...
    .ForMember(dest => dest.Uloga, opt => opt.MapFrom(src => src.Uloga.Naziv));
            ...
            CreateMap<Database.RadniProstor, RadniProstor>();


            CreateMap<Database.RezervacijaProstora20022025, RezervacijaProstora20022025>()
              .ForMember(dest => dest.Ime, opt => opt.MapFrom(src => src.Korisnik.Ime)).ForMember(dest => dest.Prezime, opt => opt.MapFrom(src => src.Korisnik.Prezime))
              .ForMember(dest => dest.Oznaka, opt => opt.MapFrom(src => src.RadniProstor.Oznaka))
              .ForMember(dest => dest.Kapacitet, opt => opt.MapFrom(src => src.RadniProstor.Kapacitet));
            CreateMap<RezervacijaProstora20022025InsertRequest, Database.RezervacijaProstora20022025>();
